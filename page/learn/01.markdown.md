...
> 如果你还不了解 Markdown ，请先了解下Markdown的简单用法 [原文链接](https://vitepress.yiov.top/markdown.html)
>
...
> 为什么和我不一样？
>
> 我对样式进行了修改，请查看 [样式美化 - 容器颜色](https://vitepress.yiov.top/style.html#容器颜色)
...
::: tip 为什么我的有小圆点
因为我对 [代码块样式](https://vitepress.yiov.top/style.html#代码块) 进行了美化，可以按需配置
:::
...
::: tip 为什么我的有小圆点
因为我对 [代码组样式](https://vitepress.yiov.top/style.html#代码组) 进行了美化，可以按需配置
:::
...
::: danger 如何做到的呢
请参考 [样式美化-代码块带标题](https://vitepress.yiov.top/style.html#代码块带标题) 教程
:::
...
[点我查看：团队成员信息](https://vitepress.yiov.top/team.html)
